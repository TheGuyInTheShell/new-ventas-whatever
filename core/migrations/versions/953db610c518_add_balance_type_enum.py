"""Add balance_type_enum

Revision ID: 953db610c518
Revises: e334b0c44583
Create Date: 2026-05-06 19:23:27.022933
...
revision: str = '953db610c518'
down_revision: Union[str, None] = 'e334b0c44583'
...
def upgrade() -> None:
    ...
    op.alter_column('balances', 'type',
               ...
               type_=sa.Enum('basic', 'adjustment', name='balance_type_enum'),
               existing_nullable=False,
               postgresql_using="CASE WHEN type = 'BASIC' THEN 'basic'::balance_type_enum WHEN type = 'adjusment' THEN 'adjustment'::balance_type_enum WHEN type = 'ADJUSTMENT' THEN 'adjustment'::balance_type_enum ELSE LOWER(type)::balance_type_enum END")
...
def downgrade() -> None:
    ...
    op.alter_column('balances', 'type',
               existing_type=sa.Enum('BASIC', 'ADJUSTMENT', name='balance_type_enum'),
               type_=sa.VARCHAR(),
               existing_nullable=False)
    # ### end Alembic commands ###
