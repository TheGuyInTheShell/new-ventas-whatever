...
def upgrade() -> None:
    ...
    op.create_index('ix_comparation_values_context_active', 'comparation_values', ['context'], unique=False, postgres_where=sa.text('deleted_at IS NULL'))
...
def downgrade() -> None:
    ...
    op.drop_index('ix_comparation_values_context_active', table_name='comparation_values', postgres_where=sa.text('deleted_at IS NULL'))
