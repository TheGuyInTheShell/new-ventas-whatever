"""Add context to permissions table

Revision ID: 560dbb8caa45
Revises: 0c68a46a4a24
Create Date: 2026-04-13 16:11:32.809263
...
revision: str = '560dbb8caa45'
down_revision: Union[str, None] = '0c68a46a4a24'
...
def upgrade() -> None:
    ...
    op.add_column('permissions', sa.Column('context', sa.String(length=50), nullable=False))
