...
class OptionsController(Controller):
    ...
    async def create_option(self, payload: CreateOption, db: AsyncSession = Depends(get_async_db)):
        return await self.OptionsService.create_options(payload.name, payload.context, payload.value)
    ...
    async def update_option(self, id: str, payload: CreateOption, db: AsyncSession = Depends(get_async_db)):
        update_data = {
            "name": payload.name,
