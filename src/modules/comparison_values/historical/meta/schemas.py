...
class RQMetaComparisonValuesHistorical(BaseModel):
...
class RSMetaComparisonValuesHistorical(BaseModel):
...
class RSMetaComparisonValuesHistoricalList(BaseModel):
    """Response schema for list of metas"""
    data: list[RSMetaComparisonValuesHistorical] | List = []
    total: int = 0
    page: int | None = 0
