...
# prefix /business_entities/hierarchy (auto-registered)
router = APIRouter()

tag = "business_entities_hierarchy"


def hierarchy_to_response(h: BusinessEntitiesHierarchy) -> RSBusinessEntitiesHierarchy:
...
@router.get("/id/{id}", response_model=RSBusinessEntitiesHierarchy, status_code=200, tags=[tag])
...
@router.get("/", response_model=RSBusinessEntitiesHierarchyList, status_code=200, tags=[tag])
...
@router.get("/children/{entity_id}", response_model=List[RSBusinessEntitiesHierarchy], status_code=200, tags=[tag])
...
@router.get("/parents/{entity_id}", response_model=List[RSBusinessEntitiesHierarchy], status_code=200, tags=[tag])
...
@router.post("/", response_model=RSBusinessEntitiesHierarchy, status_code=201, tags=[tag])
...
@router.put("/id/{id}", response_model=RSBusinessEntitiesHierarchy, status_code=200, tags=[tag])
