...
try:
    ...
    def generate_module(*args, **kwargs): pass
...
try:
    ...
    def generate_webhook(*args, **kwargs): pass
...
Examples:
  ...
  python cli.py generate:plugin mailer
    ...
    parser.add_argument("command", help="Command to execute (e.g., generate:module)")
    ...
    parser.add_argument(
        ...
        action="store_true",
        dest="in_only",
        help="Generate inbound webhook only",
    )
    parser.add_argument(
        "--out",
        action="store_true",
        dest="out_only",
        help="Generate outbound webhook only",
    )
    ...
    if args.command == "generate:module":
        ...
        print(
            "  generate:webhook <name>  - Generate a new webhook (use --in or --out for specific ones)"
        )
